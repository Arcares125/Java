...
public class Main {
	...
	void input() {
		...
		if(type.equals("Vege")) {
			...
			}while(!(vegType.equalsIgnoreCase("Potato") || vegType.equalsIgnoreCase("Tomato")));
			if(hitung < 10) {
				id = "VV" + "0"+"0"+ hitung;
			...
			if(myFood.isEmpty()) {
				...
				for(Food cekFood : myFood) {
					if(cekFood instanceof Vege) {
						...
						System.out.println("ID: "+ ((Vege)cekFood).getId());
						System.out.println("Name: "+((Vege)cekFood).getName());
						System.out.println("Price: " + cekFood.calculate());
						System.out.println("Type: "+ cekFood.getType());
						nomor++;
					} else if(cekFood instanceof NonVege) {
						System.out.println("Nomor. "+nomor);
						System.out.println("ID: "+ ((NonVege)cekFood).getId());
						System.out.println("Name: "+((NonVege)cekFood).getName());
						System.out.println("Price: " + cekFood.calculate());
						System.out.println("Type: "+ cekFood.getType());
						nomor++;
					}
...
//		}
	...
	void delete() {
		if(myFood.isEmpty()) {
			...
			System.out.println("Grand Total: "+ myFood.get(pilihMenu-1).calculate()*quantity);
